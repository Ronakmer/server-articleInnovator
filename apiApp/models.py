...
class article(models.Model):
    ...
    workspace_id = models.ForeignKey(to=workspace, on_delete=models.CASCADE, null=True, blank=True)    
    wp_title = models.CharField(max_length=5000, default="",  blank=True)
    wp_post_id = models.CharField(max_length=200, default="",  blank=True)
    wp_excerpt = models.CharField(max_length=5000, default="",  blank=True)
    ...
    wp_slug = models.CharField(max_length=5000, default="",  blank=True)
    wp_content = models.CharField(max_length=5000, default="",  blank=True)
