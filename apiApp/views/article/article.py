...
from apiApp.views.article.supportive_methods.update_manual_article import update_manual_article
...
def update_article(request, slug_id):
    try:
        ...
        response = update_manual_article(request_user, request.data)
