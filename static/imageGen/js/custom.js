(function($) {
    ...
    $(document).ready(function () {
        ...
        $('#palleon').palleon({
            base_url: "./", // The url of the main directory. For example; "http://www.mysite.com/palleon-js/"
            ...
            saveTemplate: function(selector, template) {
                ...
                var imageTemplateCategory = selector.find('#palleon-adjust #palleon-image-template-category').val();
                if(!imageTemplateCategory.length){
                    alert("Image Template Category are required.");
                    return;
                }
                var imageKit = selector.find('#palleon-adjust #palleon-image-kit').val();
                // const imageKit = document.querySelector('input[name="imageKit"]:checked');
                if(!imageKit){
                    alert("Image Kit are required.");
                    return;
                }
                ...
                template['imageTemplateCategory'] = imageTemplateCategory;
                template['imageKit'] = imageKit;
                ...
                //get a image kit congig
                // const selectedRadio = document.querySelector('input[name="imageKit"]:checked');
                const imagekit_slug_id = imageKit;
                ...
                var send_data = {"img_data": imgData, "template_name": template_name, "imagekit_slug_id":imagekit_slug_id, "workspace_slug_id":workspace_slug_id}

            
                $.ajax({
                    url: generate_template_url,
                    // url: '/upload-image/',
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        var template_image_path = data.image_url;

                        var json_data = {};
                        json_data['template_name'] = template_name;
                        json_data['template_json'] = template;
                        json_data['image_tags'] = imageTags;
                        json_data['image_template_category'] = imageTemplateCategory;
                        json_data['image_kit'] = imageKit;
                        ...
                        json_data['imagekit_slug_id'] = imagekit_slug_id;
                        json_data['workspace_slug_id'] = workspace_slug_id;
                        json_data['imagekit_slug_id '] = imagekit_slug_id;
                        console.log(json_data)
                        $.ajax({
                            type: "POST",
                            // url: "/save-template/",
                            url: add_image_template_url,
