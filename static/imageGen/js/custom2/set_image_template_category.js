...
async function get_image_template_category_api() {
    try {
        ...
        if (response.ok) {
            ...
            console.log('fetched successfully image_template_category :', data);
                
            set_image_template_category_api(data)
...
// call 
get_image_template_category_api()




// Function to populate the dropdown
function set_image_template_category_api(data) {
    const selectElement = document.getElementById("palleon-image-template-category");
