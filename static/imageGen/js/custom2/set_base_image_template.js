...
async function get_base_image_template_api(slug_id=NaN) {
    try {
        ...
        const response = await fetch(`${list_base_image_template_url}?${query_params.toString()}`, {
            method: 'GET',
            headers: {
...
function set_template_grid(responseData) {
    ...
    console.log(responseData.data,'55555555555555555555555')
    ...
    // Loop through the data data and populate the grid
