...
function connect_domain() {
    ...
    const connect_url = `${url}?app_name=${app_name}&app_id=${app_id}&success_url=${add_domain_page_url}`; 
...
wp_username = urlParams.get('user_login');
wp_password = urlParams.get('password');
...
console.log('domain_name:', domain_name);
const domain_name_element = document.querySelector('[name="name"]');
