...
let user_avatar_image_id = '';


// get_avatar_image_api
async function user_get_avatar_image_api() {
    try {
        ...
        if (response.ok) {
            ...
            user_set_avatar_image_data(data)
...
function user_set_avatar_image_data(data) {
    // Get the container where the images will be inserted
    const container = document.getElementById('user-avatar-images-container');
    ...
    data.data.forEach((obj, index) => {
        ...
        img.addEventListener('click', function() {
            ...
            if (!isSelected) {
                ...
                user_avatar_image_id = obj.avatar_image;
            } else {
                console.log('Deselected image');
                user_avatar_image_id = null; // Clear the selection
            }
        });
