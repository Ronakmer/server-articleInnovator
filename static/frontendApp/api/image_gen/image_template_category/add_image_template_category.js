...
function add_image_template_category_api() {

    // Get the form element
    const image_template_category_form = document.querySelector('[name="image_template_category_form"]');
    ...
    (async ()=>{ 
        if (is_update_page) {
            ...
            await update_api(update_image_template_category_url, data, slug_id, list_image_template_category_page_url);
        } else {
            await add_api(add_image_template_category_url, data, list_image_template_category_page_url);
        }
    })()
...
(async ()=>{      
    ...
    if (current_url.includes('/update/')) {
        ...
        const temp_api_url = `${list_image_template_category_url}?slug_id=${slug_id}`;
