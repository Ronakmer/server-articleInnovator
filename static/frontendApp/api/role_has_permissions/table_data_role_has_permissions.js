...
//                                 data-permission="${slug_id}" data-role="${role}" 
//                                 ${hasPermission(roles, role, slug_id) ? "checked" : ""}>
//                         </div>
//                     `).join("")}
//                 </div>
//             `;
...
//                 if (hasPermission(roles, role, slug_id)) {
//                     permissionsList.push({ role, permission: slug_id, status: true });
//                 }
//             });
//         });
//     });
