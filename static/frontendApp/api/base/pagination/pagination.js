...
//       paginationControls.className = 'hidden sm:flex sm:flex-1 sm:items-center sm:justify-end';
...
//           prevButton.href = '#';
//           prevButton.className = 'relative inline-flex items-center rounded-lg px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0';
...
//               pageButton.className = `relative inline-flex items-center rounded-lg px-4 py-2 text-sm font-semibold ${
//                   page === current_page
...
//           nextButton.href = '#';
//           nextButton.className = 'relative inline-flex items-center rounded-lg px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0';
