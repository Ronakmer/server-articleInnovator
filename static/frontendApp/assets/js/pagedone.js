document.addEventListener("DOMContentLoaded", () => {
  ...
  const defaultAccordionGroup = document.querySelector(
    '.accordion-group[data-accordion="default-accordion"]',
  );
  const alwaysOpenAccordionGroup = document.querySelector(
    '.accordion-group[data-accordion="always-open-accordion"]',
  );
  const nestedAccordionGroup = document.querySelector(
    '.accordion-group[data-accordion="nested-accordion"]',
  );
  const openModalButtons = document.querySelectorAll(".modal-button");
  const tooltipsButtons = document.querySelectorAll(
    "button[data-tooltip-target]",
  );
  const alertButtons = document.querySelectorAll('[data-dismiss="alert"]');
  const sidebarButtons = document.querySelector(
    '[data-pd-overlay="#docs-sidebar"]',
  );
...
function defaultAccordion(defaultAccordionGroup) {
  const accordionButtons =
    defaultAccordionGroup.querySelectorAll(".accordion-toggle");
...
function alwaysOpenAccordion(alwaysOpenAccordionGroup) {
  const accordionButtons =
    alwaysOpenAccordionGroup.querySelectorAll(".accordion-toggle");
